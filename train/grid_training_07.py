...
rl_config = RLConfig(obs_dim=obv_dim, action_dim=action_dim, algorithm=RLAlgorithm.GRID_AGENT,
                     device=device,name="Grid_Agent", double_dqn = False, batch_size=60, lr=1e-3, gamma=0.99,
                     eps_start=1.0, eps_end=5e-6, eps_decay=100_000, target_update=1000, buffer_size=500_000)
...
singleTrainer = training_manager.SingleTrainer("./runs/Test/07/50k","./checkpoints/Test/07/50k",t_config)
