...
rl_config = PPOConfig(obs_dim=obv_dim, action_dim=action_dim, algorithm=RLAlgorithm.PPO,
                     device=device,name="PPO Agent, 0.01 penalty, 2-3 safety margin and 8 sections 40k", batch_size=64, lr=1e-3, gamma=0.99,
...
agent.load(rf"./checkpoints/Test/19/PPO Agent, 0.01 penalty, 2/3 safety margin and 8 sections/final.pth")
