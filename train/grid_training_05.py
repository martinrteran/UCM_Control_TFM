...
rl_config = RLConfig(obs_dim=obv_dim, action_dim=action_dim, algorithm=RLAlgorithm.GRID_AGENT,
                     device=device,name="Grid_Agent", double_dqn = False, batch_size=30, lr=1e-2, gamma=0.90,
                     eps_start=1.0, eps_end=0.005, eps_decay=1_000_000, target_update=1000, buffer_size=1_000_000)
...
singleTrainer = training_manager.SingleTrainer("./runs/Test/05/300k","./checkpoints/Test/05/300k",t_config)
