...
rl_config = RLConfig(obs_dim=obv_dim, action_dim=action_dim, algorithm=RLAlgorithm.GRID_AGENT,
                     ...
                     eps_start=1.0, eps_end=0.005, eps_decay=100_000, target_update=1000, buffer_size=100_000)
...
singleTrainer = training_manager.SingleTrainer("./runs/Test/03/soft_reset_2","./checkpoints/Test_03_2",t_config)
