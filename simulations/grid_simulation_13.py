...
rl_config = RLConfig(obs_dim=obv_dim, action_dim=action_dim, algorithm=RLAlgorithm.SIMPLE_Q_NETWORK,
                     device=device,name="Simple Q Network", double_dqn = True, batch_size=64, lr=1e-3, gamma=0.99,
                     eps_start=1.0, eps_end=0.05, eps_decay=1_000_000, target_update=1000, buffer_size=100_000,
                     max_grad_norm=5.0)
...
singleTrainer = training_manager.SingleTrainer("./runs/Test/13/Regular_1","./checkpoints/Test/13/Regular_1",t_config)
